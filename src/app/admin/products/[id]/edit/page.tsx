  ...
  useEffect(() => {
    ...
    supabase.from('products').select('*').eq('id', id).single().then(({ data }) => {
      if (data) setForm({
        ...
        piece_count: data.piece_count?.toString() || '',
        minifig_count: data.minifig_count?.toString() || '',
    ...
    <div className="animate-fade-in max-w-lg">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input name="product_number" value={form.product_number} onChange={handleChange} className="input-threads w-full" />
        </div>
        <div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <input name="age_range" value={form.age_range} onChange={handleChange} className="input-threads w-full" />
          </div>
          <div>
